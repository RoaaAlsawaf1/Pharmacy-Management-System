  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:Row(
          children: [
            Text("9".tr,style: TextStyle(color: Colors.black87,fontSize: 16,fontWeight: FontWeight.normal),),
          ],
        ) ,
        actions: [
          Padding(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image:const AssetImage('images/tea.jpg'),
                              fit: BoxFit.cover,
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius:const BorderRadius.all(Radius.circular(16)),
                            image: DecorationImage(
                              image:const AssetImage('images/Ashwagandha.jpg'),
                              fit: BoxFit.cover,
                              colorFilter: ColorFilter.mode(Colors.white.withOpacity(0.35),BlendMode.dstATop),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius:const BorderRadius.all(Radius.circular(16)),
                            image: DecorationImage(
                              image:const AssetImage('images/lemon.jpg'),
                              fit: BoxFit.cover,
                              colorFilter: ColorFilter.mode(Colors.white.withOpacity(0.35),BlendMode.dstATop),
                  ...
                  Padding(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Text("123".tr,style:GoogleFonts.abhayaLibre(fontSize:54,fontWeight: FontWeight.bold,
                            color:Colors.white),)
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Text("132".tr,style:GoogleFonts.abhayaLibre(fontSize:54,fontWeight: FontWeight.bold,
                            color:Colors.white),)
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Text("133".tr,style:GoogleFonts.abhayaLibre(fontSize:54,fontWeight: FontWeight.bold,
                            color:Colors.white),)
                      ],
                    ),
