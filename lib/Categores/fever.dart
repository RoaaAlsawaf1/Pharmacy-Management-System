  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:Row(
          children: [
            Text("120".tr,style: TextStyle(color: Colors.black87,fontSize: 16,fontWeight: FontWeight.normal),),
          ],
        ) ,
        actions: [
          Padding(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image:const AssetImage('images/mint.jpg'),
                              fit: BoxFit.cover,
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: const BorderRadius.all(Radius.circular(16)),
                            image: DecorationImage(
                              image:const AssetImage('images/cinnamon.jpg'),
                              fit: BoxFit.cover,
                              colorFilter: ColorFilter.mode(Colors.white.withOpacity(0.35),BlendMode.dstATop),
                  ...
                  Padding(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Text("121".tr,style:GoogleFonts.abhayaLibre(fontSize:54,fontWeight: FontWeight.bold,
                            color:Colors.white),)
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Text("122".tr,style:GoogleFonts.abhayaLibre(fontSize:54,fontWeight: FontWeight.bold,
                            color:Colors.white),)
                      ],
                    ),
